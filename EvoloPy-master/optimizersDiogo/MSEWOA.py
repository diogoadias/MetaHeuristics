...
def MSEWOA(objf,lb,ub,dim,SearchAgents_no,Max_iter,Positions,best_all,best_position,t):  
    ...
    print("MSEWOA is optimizing  \""+objf.__name__+"\"")    
    ...
    for i in range(0,SearchAgents_no):
        ...
        for j in range(dim):
            Positions[i,j]= f.chaotic(cm ,t, Positions[i,j])        
