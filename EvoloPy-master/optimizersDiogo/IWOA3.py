...
def IWOA3(objf,lb,ub,dim,SearchAgents_no,Max_iter):
    ...
    print("IWOA3 is optimizing  \""+objf.__name__+"\"")    
    ...
    while t<Max_iter:
        ...
        # is introduced by Lu,Hu and Bai[17] who propose an Exponential Decreasing Inertia Weight (EDIW) strategy
